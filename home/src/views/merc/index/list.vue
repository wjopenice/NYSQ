  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-table :data="list" stripe style="width: 100%">
        <el-table-column prop="m_id" label="ID" width="100"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <router-link :to="'save?id='+scope.row.m_id">
              <el-button type="primary" size="small" icon="el-icon-edit">编辑</el-button>
            </router-link>
            <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row.m_id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
